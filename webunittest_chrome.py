...
class BasicTest(unittest.TestCase):
    def setUp(self):
        ...
        self.username = "522161508@qq.com"
        self.authkey  = "ub97d8fd1f863abf"
    ...
    def test_CBT(self):
        ...
        try:
            # load the page url
            print('Loading Url')
            self.driver.get('https://ec601-hw2-task1-publish.firebaseapp.com')
            ...
            self.assertEqual("Qinjin Jia - Qinjin Jia's Resume", self.driver.title)
